...
export default function ComparePage() {
    ...
    if (compareList.length === 0) {
        return (
            <div className="min-h-[70vh] bg-slate-50 flex flex-col items-center justify-center px-4 font-montserrat text-center">
    ...
    return (
        <div className="min-h-screen bg-slate-50 font-montserrat pb-32">
            {/* Header Area */}
