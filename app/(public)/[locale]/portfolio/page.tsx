        ...
        <main className="min-h-screen bg-white pt-32 pb-24">
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <div className="inline-flex items-center bg-gold-500/10 text-gold-600 px-4 py-2 rounded-full mb-6 font-montserrat font-semibold text-sm tracking-wider uppercase">
                ...
                {totalSold > 0 && (
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-16 max-w-2xl mx-auto">
                        <div className="text-center p-6 bg-slate-50 border border-gray-100">
                            ...
                            <p className="text-sm text-gray-500 font-montserrat mt-1">{t('propertiesSold')}</p>
                        </div>
                        <div className="text-center p-6 bg-slate-50 border border-gray-100">
                            <p className="text-3xl md:text-4xl font-playfair font-bold text-navy-900">${(totalValue / 1000000).toFixed(1)}M</p>
                            <p className="text-sm text-gray-500 font-montserrat mt-1">{t('totalValue')}</p>
                        </div>
                        <div className="text-center p-6 bg-slate-50 border border-gray-100 col-span-2 md:col-span-1">
                            ...
                            <p className="text-sm text-gray-500 font-montserrat mt-1">{locale === 'es' ? 'Satisfacción del Cliente' : 'Client Satisfaction'}</p>
                        </div>
                    </div>
                )}
                                ...
                                >
                                    ...
                                    <div className="relative aspect-[16/10] overflow-hidden bg-gray-100">
                                        ...
                                        <div className="absolute top-4 left-4">
                                            <span className="bg-red-600 text-white text-xs font-bold tracking-wider uppercase px-3 py-1.5 font-montserrat">
                                                {locale === 'es' ? 'VENDIDA' : 'SOLD'}
                                            </span>
                                        </div>
                                        {/* Achieved Price */}
                                        <div className="absolute bottom-4 right-4">
                                            <span className="bg-navy-900/90 backdrop-blur-sm text-white text-sm font-semibold px-3 py-1.5 font-montserrat">
                                    ...
                                    <div className="p-5">
                                        ...
                                        <p className="text-sm text-gray-500 font-montserrat flex items-center mb-3">
                                            <MapPin className="w-3.5 h-3.5 mr-1" />
                                            {city}
                                        </p>
                                        <div className="flex items-center gap-4 text-xs text-gray-500 font-montserrat">
                ...
                <div className="text-center mt-16 pt-12 border-t border-gray-100">
                    ...
                    <p className="text-gray-600 font-montserrat mb-6 max-w-md mx-auto">
                        {locale === 'es'
                    ...
                    <Link
                        href={`/${locale}/contact`}
                        className="inline-flex items-center bg-navy-900 hover:bg-navy-800 text-white px-8 py-3.5 font-montserrat text-sm uppercase tracking-wider transition-colors"
                    >
