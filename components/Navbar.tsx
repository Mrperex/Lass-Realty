            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-20">
                    ...
                    <nav className="hidden md:flex space-x-8 items-center">
                        ...
                        <Link href="/market-reports" className="text-slate-600 hover:text-champagne-500 font-bold uppercase tracking-widest text-xs transition-colors">{t('marketReports')}</Link>
